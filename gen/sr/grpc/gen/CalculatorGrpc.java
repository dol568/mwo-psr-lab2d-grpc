...
public final class CalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sr.grpc.gen.AverageOpArguments,
      sr.grpc.gen.AverageOpResult> getAverageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Average",
      requestType = sr.grpc.gen.AverageOpArguments.class,
      responseType = sr.grpc.gen.AverageOpResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sr.grpc.gen.AverageOpArguments,
      sr.grpc.gen.AverageOpResult> getAverageMethod() {
    io.grpc.MethodDescriptor<sr.grpc.gen.AverageOpArguments, sr.grpc.gen.AverageOpResult> getAverageMethod;
    if ((getAverageMethod = CalculatorGrpc.getAverageMethod) == null) {
      synchronized (CalculatorGrpc.class) {
        if ((getAverageMethod = CalculatorGrpc.getAverageMethod) == null) {
          CalculatorGrpc.getAverageMethod = getAverageMethod =
              io.grpc.MethodDescriptor.<sr.grpc.gen.AverageOpArguments, sr.grpc.gen.AverageOpResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Average"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.AverageOpArguments.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.AverageOpResult.getDefaultInstance()))
              .setSchemaDescriptor(new CalculatorMethodDescriptorSupplier("Average"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void average(sr.grpc.gen.AverageOpArguments request,
  ...
  public static final class CalculatorBlockingStub
    ...
    /**
     */
    public sr.grpc.gen.AverageOpResult average(sr.grpc.gen.AverageOpArguments request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CalculatorFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sr.grpc.gen.AverageOpResult> average(
        sr.grpc.gen.AverageOpArguments request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_AVERAGE:
          serviceImpl.average((sr.grpc.gen.AverageOpArguments) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.AverageOpResult>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              sr.grpc.gen.AverageOpArguments,
              sr.grpc.gen.AverageOpResult>(
